...
const (
	...
	Arithmetic_Devide_FullMethodName   = "/arithmetic.Arithmetic/Devide"
)
...
type ArithmeticClient interface {
	...
	Subtract(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error)
	Multiply(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error)
	Devide(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error)
}
...
func (c *arithmeticClient) Add(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error) {
...
func (c *arithmeticClient) Subtract(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ArithmeticResponse)
	err := c.cc.Invoke(ctx, Arithmetic_Subtract_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arithmeticClient) Multiply(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ArithmeticResponse)
	err := c.cc.Invoke(ctx, Arithmetic_Multiply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *arithmeticClient) Devide(ctx context.Context, in *ArithmeticRequest, opts ...grpc.CallOption) (*ArithmeticResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ArithmeticResponse)
	err := c.cc.Invoke(ctx, Arithmetic_Devide_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ArithmeticServer interface {
	...
	Subtract(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error)
	Multiply(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error)
	Devide(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error)
...
func (UnimplementedArithmeticServer) Add(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedArithmeticServer) Subtract(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subtract not implemented")
}
func (UnimplementedArithmeticServer) Multiply(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Multiply not implemented")
}
func (UnimplementedArithmeticServer) Devide(context.Context, *ArithmeticRequest) (*ArithmeticResponse, error) {
...
func _Arithmetic_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServer).Add(ctx, req.(*ArithmeticRequest))
	}
...
func _Arithmetic_Subtract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServer).Subtract(ctx, req.(*ArithmeticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Arithmetic_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServer).Multiply(ctx, req.(*ArithmeticRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Arithmetic_Devide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ArithmeticRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ArithmeticServer).Devide(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Arithmetic_Devide_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServer).Devide(ctx, req.(*ArithmeticRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Arithmetic_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Devide",
			Handler:    _Arithmetic_Devide_Handler,
		},
	},
